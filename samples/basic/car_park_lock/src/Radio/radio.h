...
typedef enum{
    SX1276_DIO_0_IRQ_EVENT = 0,
    SX1276_DIO_1_IRQ_EVENT,
    SX1276_DIO_2_IRQ_EVENT,
    SX1276_DIO_3_IRQ_EVENT,
    SX1276_TIMEOUT_EVENT,
}en_RADIO_EVENT,*pen_RADIO_EVENT;

struct radio_event_type {
    en_RADIO_EVENT event;
};
