...
The Zephyr car_park_lock board configuration supports the following hardware features:
...
``boards/arm/car_park_lock/car_park_lock_defconfig``
...
Board connectors:
-----------------
.. image:: img/car_park_lock_connectors.png
   :width: 800px
   :align: center
   :height: 619px
...
Applications for the ``car_park_lock`` board configuration can be built and
